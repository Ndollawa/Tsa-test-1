<template>
    ...
    >
        ...
        >
            <!-- LEFT CONTENT -->
            <div class="relative grid w-full grid-cols-1 py-auto md:pl-20 xl:pl-24">
                <div
                    v-motion
